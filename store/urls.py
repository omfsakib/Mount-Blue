...
urlpatterns = [
    ...
    path('shop/add-color/',views.addColors,name="add-color"),
    path('shop/product-view/<str:pk>/',views.shopProductView,name="shop-product-view"),
    path('shop/product-edit/<str:pk>/',views.shopProductEdit,name="shop-product-edit"),
    path('shop/shop-product/',views.shopProducts,name="shop-product"),
    path('shop/offline-order/memoPrint/<str:pk>/',views.memoPrint,name="memo-print"),
    path('cart/',views.cart,name="cart"),
    path('checkout/',views.checkout,name="checkout"),
    path('products/',views.products,name="products"),
    path('totalOrders/',views.totalOrders,name="total-orders"),
