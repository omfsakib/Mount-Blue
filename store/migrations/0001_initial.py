# Generated by Django 4.0.3 on 2022-08-24 18:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_for', models.CharField(blank=True, choices=[('woman', 'Woman'), ('man', 'Man')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.shopowner')),
            ],
        ),
        migrations.AddField(
            model_name='order',
